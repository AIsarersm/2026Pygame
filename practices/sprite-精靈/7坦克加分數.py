...
class Game:
    ...
    def render(self):
        ...
        # 更新渲染分數 TODO 4
        text_surface = self.mark_obj.render(f"Your mark is: {self.mark}", True, (0, 0, 100), (0, 100, 0))
        self.main_surface.blit(text_surface, (430, 0))
    ...
    def collision_detection(self):
        ...
        for bullet, hit_enemies in hit_enemy_list.items():
            for hit_enemy in hit_enemies:
                self.mark += 1  # 我方子彈每打中一個敵方坦克，+1分 TODO 3
