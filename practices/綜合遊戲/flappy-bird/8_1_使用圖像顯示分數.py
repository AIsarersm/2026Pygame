import pygame
import random
from FlappyMark import FlappyMark  # TODO 0 導入FlappyMark 本地模組
...
class Game:
    def __init__(self):
        ...
        # 6. Mark Show Obj
        self.flappy_mark = FlappyMark(1.5)   # TODO 1 設置圖像顯示分數的對象
        # 變量:
        self.running = True
        self.mark = 0
        # 常量:
    ...
    def render(self):
        ...
        # TODO 2 調用讓對象的方法，把分數傳入返回對應的surface對象
        mark_sub_obj = self.flappy_mark.get_num_surface_obj(self.mark)
        # TODO 3 放到對應位置，這里的x位置兼容了分數surface對象的寬度，保証圖像一定放在中間
