...
class Game:
    def __init__(self):
        ...
        # 5. enemy group
        self.enemies_group = pygame.sprite.Group()  # 創建一個敵方坦克的管理Group TODO 2
        # 6. enemy bullets group
        self.enemies_bullets_group = pygame.sprite.Group()  # 創建一個敵方坦克子彈的管理Group TODO 6
        # 變量:
        self.running = True
    ...
    def update(self):
        ...
        self.enemies_group.update()  # 敵人所有坦克自動向左移動 TODO 4
        self.enemies_bullets_group.update()  # 敵人所有子彈自動向左移動  TODO 8
    ...
    def render(self):
        ...
        self.enemies_group.draw(self.main_surface)  # 敵人所有坦克自動渲染 TODO 5
        self.enemies_bullets_group.draw(self.main_surface)  # 敵人所有子彈自動渲染 TODO 9
