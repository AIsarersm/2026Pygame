...
class Game:
    def __init__(self):
        ...
        # 6. Font 對象  # TODO 1 定義Font對象
        self.mark_font_obj = pygame.font.SysFont("arial", 50)
        self.mark_font_obj.bold = True
        # 變量:
        self.running = True
        self.mark = 0
        # 常量:
    ...
    def render(self):
        ...
        # TODO 2 定義一個分數，顏色是白色，沒有背景色的surface對象，把它放在對應位置
        text_surface = self.mark_font_obj.render(str(self.mark), True, (255, 255, 255), None)
        self.main_surface.blit(text_surface, (SCREEN_WIDTH//2 - text_surface.get_size()[0] // 2, 50))
